    ...
    <PageTransition className="mx-auto max-w-7xl p-5 space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-foreground">Projected Entries</h1>
            <p className="text-[11px] text-muted-foreground">P&L entries with projected metrics</p>
          </div>
        </div>
