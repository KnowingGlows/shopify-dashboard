...
export default function AdsInternationalPage() {
  ...
  return (
    <PageTransition className="mx-auto max-w-7xl p-5 space-y-4">
      ...
      {/* KPI tiles — modern card style with hover glow */}
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        <StatCell label="Total creatives" value={summary.total.toLocaleString('en-IN')}   accent="violet"  delay={0} />
        <StatCell label="Live"            value={summary.live.toLocaleString('en-IN')}    accent="emerald" delay={0.05} />
