...
import {
  ...
  Calculator, PackageCheck, PackageX, Funnel as FunnelIcon, Layers, Trophy, Boxes, Ban, Wallet, Landmark,
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { href: '/finance', label: 'Finance', icon: Landmark, section: 'core' },
  ...
  { href: '/funnels', label: 'LPs', icon: FunnelIcon, section: 'marketing' },
  { href: '/ads-international', label: 'Ads', icon: Layers, section: 'marketing' },
